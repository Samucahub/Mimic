...
python3 -c "import pygame" 2>/dev/null || { echo "Installing pygame..."; sudo pip3 install pygame; }
python3 -c "import yaml" 2>/dev/null || { echo "Installing pyyaml..."; sudo pip3 install pyyaml; }
python3 -c "import asyncssh" 2>/dev/null || { echo "Installing asyncssh..."; sudo pip3 install asyncssh; }
