...
class SecurityLayer:
    ...
    def detect_brute_force(self, ip: str, data: Dict) -> Optional[str]:
        if 'password_attempts' in data:
            ...
            if attempts >= 5:  # Detection threshold
                return 'brute_force'
        ...
        if len(recent_failures) >= 3:
            if len(recent_failures) >= 3:
                ...
                if time_diff < 10:  # 3 failures in less than 10 seconds
                    return 'brute_force'
